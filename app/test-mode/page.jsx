...
export default function TestModePage() {
  ...
  const handleToggle = () => {
    ...
    alert(
      `Test mode ${newTestMode ? 'enabled' : 'disabled'} for salon ID: ${salonId}`,
    );
  ...
  return (
    <div style={{ padding: '2rem', fontFamily: 'sans-serif' }}>
      ...
      <p>
        This page allows you to enable a test mode to bypass authentication and
        view the dashboard for a specific tenant.
      </p>
      ...
      <p style={{ marginTop: '1rem' }}>
        ...
        {testMode
          ? `Enabled for Salon ID: ${Cookies.get('test_salon_id')}`
          : 'Disabled'}
      </p>
      {testMode && (
