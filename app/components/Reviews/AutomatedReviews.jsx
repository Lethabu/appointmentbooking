...
const mockReviews = [
    {
      ...
      client_name: "Sarah M.",
      rating: 5,
      comment: "Amazing hair transformation! The team at InStyle really knows what they're doing. My highlights look perfect!",
      service: "Highlights",
      date: "2024-01-15",
      automated: true
    },
    {
      ...
      client_name: "Lisa K.",
      rating: 5,
      comment: "Best hair treatment I've ever had. My hair feels so soft and healthy now. Definitely booking again!",
    ...
    },
    {
      ...
      rating: 5,
      comment: "The bridal hair styling was absolutely perfect for my wedding day. Thank you InStyle team! ✨",
      service: "Bridal Hair",
      date: "2024-01-08",
      automated: true
    }
    ...
    <div className="space-y-6">
      ...
      {showReviewPrompt && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <p className="text-gray-600 mb-4">We'd love to hear about your visit to InStyle Hair Boutique!</p>
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="mt-6 p-4 bg-blue-50 rounded-lg">
          <h3 className="font-semibold text-blue-900 mb-2">Automated Review Management</h3>
          <ul className="text-sm text-blue-700 space-y-1">
            <li>• Automatic SMS follow-up 2 hours after service</li>
            <li>• High ratings (4-5 stars) encouraged to post publicly</li>
            <li>• Low ratings (1-2 stars) directed to management for resolution</li>
