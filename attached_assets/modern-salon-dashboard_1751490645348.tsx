    ...
    setAppointments([
      {
        ...
        price: 450,
        notes: 'Regular client, prefers subtle highlights'
      },
      {
        id: 2,
      ...
      },
      {
        ...
        price: 320,
        notes: 'Keratin treatment follow-up'
      },
      {
        id: 4,
        clientName: 'James Wilson',
        service: 'Beard Trim & Cut',
        time: '3:30 PM',
        duration: '1h',
        status: 'cancelled',
        phone: '+27 444 567 8901',
        price: 220,
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">
                <span className="text-purple-600">InStyle</span> Dashboard
              </h1>
              ...
              <div className="p-6 border-b border-gray-100">
                <div className="flex items-center justify-between">
                  ...
                  <span className="bg-purple-100 text-purple-700 px-3 py-1 rounded-full text-sm font-medium">
                    {appointments.filter(apt => apt.status !== 'cancelled').length} active
                  </span>
                </div>
              </div>
              <div className="p-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="space-y-3">
                ...
                <button className="w-full bg-gradient-to-r from-green-500 to-green-600 text-white py-3 px-4 rounded-xl hover:from-green-600 hover:to-green-700 transition-all duration-300 flex items-center justify-center gap-2 font-medium">
            ...
            <div className="bg-gradient-to-br from-purple-500 via-pink-500 to-red-500 text-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex items-start gap-3 p-3 bg-white bg-opacity-20 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="opacity-90">WhatsApp campaigns & follow-ups</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-3 bg-white bg-opacity-20 rounded-lg">
              ...
              <div className="mt-4 text-center">
                <span className="text-xs opacity-75 bg-white bg-opacity-20 px-3 py-1 rounded-full">
                  Phase 2 Development
                </span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="space-y-3">
                {['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map((day, index) => {
                  const revenue = [320, 480, 380, 520, 640, 780][index];
                  const percentage = (revenue / 800) * 100;
                  return (
                    <div key={day} className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-semibold text-gray-900 w-12">R{revenue}</span>
                    </div>
                  );
                })}
              </div>
