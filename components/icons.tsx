...
export const IconDashboard: React.FC<IconProps> = (props) => (
    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 3v11.25A2.25 2.25 0 0 0 6 16.5h12A2.25 2.25 0 0 0 20.25 14.25V3M3.75 3H20.25M3.75 3v.007v.006h16.5v-.006V3M3.75 6.75h16.5M3.75 10.5h16.5M3.75 14.25h16.5M6 16.5h12M6 16.5v4.5m12-4.5v4.5m-6-4.5v4.5" />
    </svg>
);