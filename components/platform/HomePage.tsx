...
const faqQuestions = [
  ...
  },
  {
    ...
    answer: "Yes, you can start a free trial to explore the platform's features."
  }
];
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-12">
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                ...
                <p className="text-gray-600 mb-6">Manage bookings, clients, and grow your business with AI</p>
                <Link 
                  href="/dashboard" 
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                ...
                <p className="text-gray-600 mb-6">See our platform in action with InStyle Hair Boutique</p>
                <Link 
                  href="/instyle" 
