            ...
            >
              ...
              <div className="p-6">
                ...
                <Link href={`/book/${salon.slug}`} legacyBehavior>
                  <a className="text-indigo-600 hover:text-indigo-900 font-semibold mt-4 inline-block">
                    Book Now
                  </a>
                </Link>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {salons.map((salon) => (
                        <div key={salon.id} className="bg-gray-50 rounded-lg shadow-md overflow-hidden">
                            <Image src={salon.image_url} alt={salon.name} className="w-full h-48 object-cover" width={400} height={300} />
                            <div className="p-6">
